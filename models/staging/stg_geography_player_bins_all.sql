...
, SUM(player_bin_010) / SUM(tournament_count) AS all_player_bin_010_perc
, SUM(player_bin_020) / SUM(tournament_count) AS all_player_bin_020_perc
, SUM(player_bin_030) / SUM(tournament_count) AS all_player_bin_030_perc
, SUM(player_bin_040) / SUM(tournament_count) AS all_player_bin_040_perc
, SUM(player_bin_050) / SUM(tournament_count) AS all_player_bin_050_perc
, SUM(player_bin_060) / SUM(tournament_count) AS all_player_bin_060_perc
, SUM(player_bin_070) / SUM(tournament_count) AS all_player_bin_070_perc
, SUM(player_bin_080) / SUM(tournament_count) AS all_player_bin_080_perc
, SUM(player_bin_090) / SUM(tournament_count) AS all_player_bin_090_perc
